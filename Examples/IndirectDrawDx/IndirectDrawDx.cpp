...
void IndirectDrawDx::Shutdown()
{
    FlushCommandQueue();
}

bool IndirectDrawDx::CreateDevice()
{
...
bool IndirectDrawDx::CreateCommandQueue()
{
...
bool IndirectDrawDx::CreateCommandList()
{
...
void IndirectDrawDx::BeginCommandList()
{
...
void IndirectDrawDx::EndCommandList()
{
    if(!m_CommandListIsClosed)
    {
        m_CommandList->Close();
...
bool IndirectDrawDx::CreateDescriptorHeaps()
{
...
bool IndirectDrawDx::CreateSwapChain()
{
...
void IndirectDrawDx::FlushCommandQueue()
{
