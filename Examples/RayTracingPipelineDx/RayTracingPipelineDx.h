...
public:
    ...
    static constexpr uint32_t           s_MeshInstanceCount = 3;
...
private:
    ...
    std::array<TriangleMeshInstance, s_MeshInstanceCount>   m_MeshInstances;
    ...
    Microsoft::WRL::ComPtr<ID3D12Resource>              m_InstanceTransformBuffer;
