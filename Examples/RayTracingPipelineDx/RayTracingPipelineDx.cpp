...
bool RayTracingPipelineDx::CreateCommandQueue()
{
...
bool RayTracingPipelineDx::CreateCommandList()
{
...
bool RayTracingPipelineDx::CreateDescriptorHeaps()
{
...
bool RayTracingPipelineDx::CreateSwapChain()
{
...
void RayTracingPipelineDx::BeginCommandList()
{
...
void RayTracingPipelineDx::EndCommandList()
{
    if(!m_CommandListIsClosed)
    {
        m_CommandList->Close();
...
void RayTracingPipelineDx::FlushCommandQueue()
{
